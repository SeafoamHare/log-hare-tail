...
void workerFunction(int id)
{
    for (int i = 0; i < 10; ++i)
    {
        ...
        LOG_WARN() << std::to_string(id) << " This is a warning message " << std::to_string(i) << std::endl;
        LOG_ERROR() << std::to_string(id) << " This is a error message " << std::to_string(i) << std::endl;
        LOG_CRITICAL() << std::to_string(id) << " This is a critical message " << std::to_string(i) << std::endl;
